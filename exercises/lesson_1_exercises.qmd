...
7.  Use Save As... to save a new file. Create a new folder called "output" within the MSACL-data-literacy folder. Select the new folder. Save the new file as an Excel (.xlsx) file named **batch_data_excel.xlsx**.

8.  Click on cell M2. In the formula box, enter the following:
...
9.  Convert the floating point number to a date and time recognized by Excel by right-clicking the cell, clicking on "Format Cells...", selecting "Time" from the Category list, and selecting the bottom most option in the Type window (3/14/12 13:30).
